...
public class ExpenseReqForm extends JPanel {

    JLabel lblTitle, lblName, lblDate, lblAmount, lblReason;
    ...
    public ExpenseReqForm() {
        ...
        cardPanel.setBounds(170, 40, 600, 450);
        ...
        lblTitle = new JLabel("Expense Request Form");

        lblTitle.setFont(new Font("Segoe UI", Font.BOLD, 24));

        lblTitle.setBounds(180, 25, 300, 35);
        ...
        lblDate.setBounds(60, 150, 140, 30);

        cardPanel.add(lblDate);

        txtDate = new JTextField();

        txtDate.setBounds(220, 150, 280, 32);
        ...
        lblAmount.setBounds(60, 200, 140, 30);

        cardPanel.add(lblAmount);

        txtAmount = new JTextField();

        txtAmount.setBounds(220, 200, 280, 32);
        ...
        lblReason.setBounds(60, 250, 140, 30);

        cardPanel.add(lblReason);

        txtReason = new JTextField();

        txtReason.setBounds(220, 250, 280, 32);

        cardPanel.add(txtReason);

        btnSubmit = new JButton("SUBMIT REQUEST");

        btnSubmit.setBounds(210, 340, 180, 42);
        ...
        btnSubmit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    EmployeeData.expenseRequestCount++;

                    JOptionPane.showMessageDialog(null, "Expense Request Submitted Successfully!");
